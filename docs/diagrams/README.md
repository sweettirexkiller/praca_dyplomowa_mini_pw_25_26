...
- [Connectivity Class Diagram](connectivity_class_diagram.md) - All objects involved in networking: transport packets, messages, channels, and LiveKit integration.
...
- [Connectivity Sync Protocol Sequence](connectivity_sync_protocol_sequence.md) - End-to-end CRDT sync exchange between two peers via the transport layer.

...
\end{enumerate}
\subsection{Initial synchronization of new peer}
what happens when a user joins midsession, the full sync handshake converges the newcomer to 
the current document state

% automerge_backend_cyns_sequance.md
% app_general_flow_sequance.md

% Novel solutions
\section{CRDTS Data Model - What is beeing synchronised ?}

...
- start topology, livekit SFU, client-side CRDT, WebRTC data channels, 
- detailes diagrams of architecture
- component diagram, egui - automerge - livekit/tokio networking

\section{Technology Stack}
- why rust, gui, automerge, tokio, livekit, brief description of each

...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{./images/ui-modules-2.png}
	\caption{User Interface Modules 2}
	\label{fig:ui-modules-2}
\end{figure}
...
\begin{figure}[H]
	...
	\end{minipage}
	\caption{User Interface Modules 3, 4, and 5}

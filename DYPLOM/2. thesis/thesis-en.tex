...
software is also collaborative. There are examples close to software engineers, but these applications do 
...
need for ``local-first'' architectures yet and this term has not been popularized yet. Before even the 

...
explain the \texttt{generate\_sync\_message} / \texttt{receive\_sync\_message} handshake, the role of 
	the bloom filters for tracking ``what does the peer already know'', and why multiple rounds may be needed
